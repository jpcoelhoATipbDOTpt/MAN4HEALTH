...
man4health@raspberrypi:~/RPi_man4health_clone/EPEVER $ sudo nano epever.py
man4health@raspberrypi:~/RPi_man4health_clone/EPEVER $ cat epever.py
#! /usr/bin/python3
