function resposta=pesquisa_entidades_http_progress(host,refname,refurn,progress)

opt = matlab.net.http.HTTPOptions('ProgressMonitorFcn',@MyProgressMonitor,'UseProgressMonitor',progress);
...
url="http://" + host + ":1026/ngsi-ld/v1/entities?q=" + refname + "==%22" + refurn + "%22";
