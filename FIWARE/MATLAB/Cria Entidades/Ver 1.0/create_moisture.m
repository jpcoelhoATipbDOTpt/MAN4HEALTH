...
moisture.measuredValue.type = prop;
moisture.measuredValue.value = 65; %

t = datetime('now', 'TimeZone', 'local');
moisture.dateObserved.type=prop;
moisture.dateObserved.value = datestr(t,'yyyy-mm-ddTHH:MM:ss.FFFZ');
