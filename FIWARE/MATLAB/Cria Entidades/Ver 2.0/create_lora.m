...
lora.rssi.type=prop;
lora.rssi.value=-85;
lora.rssi.unitCode="DBM";
t = datetime('now', 'TimeZone', 'local');
lora.rssi.observedAt = datestr(t,'yyyy-mm-ddTHH:MM:ss.FFFZ');

lora.NwkSkey.type = prop;
lora.NwkSkey.value = NwkSkey;

lora.AppSkey.type = prop;
lora.AppSkey.value = AppSkey;

lora.DevAddr.type = prop;
lora.DevAddr.value = DevAddr;
